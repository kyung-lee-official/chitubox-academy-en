...
export const metadata = {
	...
	openGraph: {
		images: [
			"/en/academy/images/docs/advanced/a-complete-guide-about-adding-supports-in-sladlplcd-3d-printing/cover.png",
		],
	},
};
...
<ImageContainer>
	<AntdImage
		...
		src={
			"/en/academy/images/docs/advanced/a-complete-guide-about-adding-supports-in-sladlplcd-3d-printing/top-down-and-bottom-up-3d-printing.gif"
		}
	/>
</ImageContainer>
...
<ImageContainer>
	<AntdImage
		...
		src={
			"/en/academy/images/docs/advanced/a-complete-guide-about-adding-supports-in-sladlplcd-3d-printing/letters-y-h-and-t.png"
		}
	/>
</ImageContainer>
...
<ImageComparison
	img1Src={
		"/en/academy/images/docs/advanced/a-complete-guide-about-adding-supports-in-sladlplcd-3d-printing/overhangs.png"
	}
	alt1={"overhangs"}
	img2Src={
		"/en/academy/images/docs/advanced/a-complete-guide-about-adding-supports-in-sladlplcd-3d-printing/bridges.png"
	}
	alt2={"bridges"}
/>
...
<ImageContainer>
	<AntdImage
		...
		src={
			"/en/academy/images/docs/advanced/a-complete-guide-about-adding-supports-in-sladlplcd-3d-printing/bridge-layers-broken.png"
		}
	/>
</ImageContainer>
...
<ImageContainer>
	<AntdImage
		alt="examples"
		src={
			"/en/academy/images/docs/advanced/a-complete-guide-about-adding-supports-in-sladlplcd-3d-printing/examples.jpg"
		}
	/>
</ImageContainer>
...
<ImageContainer>
	<AntdImage
		...
		src={
			"/en/academy/images/docs/advanced/a-complete-guide-about-adding-supports-in-sladlplcd-3d-printing/connection-layers01.jpg"
		}
	/>
</ImageContainer>
...
<ImageContainer>
	<AntdImage
		...
		src={
			"/en/academy/images/docs/advanced/a-complete-guide-about-adding-supports-in-sladlplcd-3d-printing/connection-layers02.jpg"
		}
	/>
</ImageContainer>
...
<DocsColumnContainer>
	<DocsColumn>
		<AntdImage
			...
			width={195}
			src={
				"/en/academy/images/docs/advanced/a-complete-guide-about-adding-supports-in-sladlplcd-3d-printing/suspendings01.jpg"
			}
		/>
	</DocsColumn>
	<DocsColumn>
		<AntdImage
			...
			width={300}
			src={
				"/en/academy/images/docs/advanced/a-complete-guide-about-adding-supports-in-sladlplcd-3d-printing/suspendings02.jpg"
			}
		/>
	</DocsColumn>
	<DocsColumn>
		<AntdImage
			...
			width={223}
			src={
				"/en/academy/images/docs/advanced/a-complete-guide-about-adding-supports-in-sladlplcd-3d-printing/suspendings03.jpg"
			}
		/>
	</DocsColumn>
</DocsColumnContainer>
...
<ImageContainer>
	<AntdImage
		...
		src={
			"/en/academy/images/docs/advanced/a-complete-guide-about-adding-supports-in-sladlplcd-3d-printing/spider-man.gif"
		}
	/>
</ImageContainer>
...
>
	<AntdImage
		...
		src={
			"/en/academy/images/docs/advanced/a-complete-guide-about-adding-supports-in-sladlplcd-3d-printing/interconnected-supports-and-individual-supports.png"
		}
	/>
</ImageContainer>
