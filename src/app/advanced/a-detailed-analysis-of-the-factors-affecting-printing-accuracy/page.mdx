export const metadata = {
	...
	openGraph: {
		images: [
			"/en/academy/images/docs/advanced/a-detailed-analysis-of-the-factors-affecting-printing-accuracy/cover.png",
		],
	},
};
...
<ImageContainer footnote="SLA">
	<AntdImage
		...
		src={
			"/en/academy/images/docs/advanced/a-detailed-analysis-of-the-factors-affecting-printing-accuracy/sla-imaging-principle.png"
		}
	/>
</ImageContainer>
...
<ImageContainer footnote="DLP">
	<AntdImage
		...
		src={
			"/en/academy/images/docs/advanced/a-detailed-analysis-of-the-factors-affecting-printing-accuracy/dlp-imaging-principle.png"
		}
	/>
</ImageContainer>
...
<ImageContainer footnote="LCD">
	<AntdImage
		...
		src={
			"/en/academy/images/docs/advanced/a-detailed-analysis-of-the-factors-affecting-printing-accuracy/lcd-imaging-principle.png"
		}
	/>
</ImageContainer>
...
<ImageContainer>
	<AntdImage
		alt="print size"
		src={
			"/en/academy/images/docs/advanced/a-detailed-analysis-of-the-factors-affecting-printing-accuracy/print-size.png"
		}
	/>
</ImageContainer>
