export const metadata = {
	...
	openGraph: {
		images: [
			"/en/academy/images/docs/advanced/a-brief-overview-of-thermal-stress-in-resin-3d-printing/cover.png",
		],
	},
};
...
<ImageContainer>
	<AntdImage
		...
		src={
			"/en/academy/images/docs/advanced/a-brief-overview-of-thermal-stress-in-resin-3d-printing/basic-equations-of-thermal-elasticity.png"
		}
		width={450}
	/>
</ImageContainer>
...
<ImageContainer>
	<AntdImage
		alt="Top-down 3D printing and Bottom-up 3D printing"
		src={
			"/en/academy/images/docs/advanced/a-brief-overview-of-thermal-stress-in-resin-3d-printing/coefficient-of-thermal-expansion-of-materials.png"
		}
	/>
</ImageContainer>
