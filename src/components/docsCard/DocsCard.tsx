...
const DocsCard = (props: any) => {
	...
	return (
		<a
			className="flex flex-col w-full min-w-[340px] h-80 p-2 gap-4
			bg-white/20
			overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 cursor-pointer"
			href={url}
			title={title}
		>
